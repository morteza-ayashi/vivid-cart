...
<div class="mt-4 flex flex-col items-center space-y-4">
    <a href="#"
       class="flex items-center w-full p-3 border border-gray-300 rounded font-roboto font-medium transition-colors duration-300 hover:bg-gray-100 rtl:flex-row-reverse">
        <div class="w-6 flex justify-center rtl:ml-3 ltr:mr-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" role="img" aria-hidden="true" class="crayons-icon crayons-icon--default">
        ...
        <span class="flex-1 text-center">{{ $ctaText }} {{ __('with Google') }}</span>
    </a>
    ...
    <a href="#"
       class="flex items-center w-full p-3 border border-gray-300 rounded font-roboto font-medium transition-colors duration-300 hover:bg-gray-100 rtl:flex-row-reverse">
        ...
        <span class="flex-1 text-center">{{ $ctaText }} {{ __('with Facebook') }}</span>
    </a>
    ...
    <a href="#"
       class="flex items-center w-full p-3 border border-gray-300 rounded font-roboto font-medium transition-colors duration-300 hover:bg-gray-100 rtl:flex-row-reverse">
        ...
        <span class="flex-1 text-center">{{ $ctaText }} {{ __('with Apple') }}</span>
    </a>
</div>
